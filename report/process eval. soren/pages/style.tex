...
\titleformat{\subsection}[runin]{\large\bfseries}{}{10pt}{\subsectionnum{subsection}~#1\label{\sectionnum{section}\subsectionnum{subsection}}}
\titleformat{\subsubsection}[runin]{\itshape}{}{0pt}{\subsectionnum{subsection}\subsubsectionnum{subsection}\qquad#1\label{\sectionnum{section}\subsectionnum{subsection}\subsubsectionnum{subsubsection}}}
